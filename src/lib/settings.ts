...
export async function getAllPolicies() {
  const defaultPolicies = {
    ...
    total_leaves_allowed: 2,
    half_days_for_one_leave: 3,
    carry_forward_leaves: true,
    carry_forward_half_days: true,
    carry_forward_reset_month: 1,
    payroll_calculation_basis: "calendar_days",
    policy_rules_text: `1. Shift Working Hours: A standard full-day shift requires 9 hours of active work.
2. Absent Threshold: If an employee logs out before completing half of the shift (< 4.5 hours), it will be automatically recorded as a FULL DAY ABSENT.
3. Half Day Policy: Working between 4.5 hours and 9 hours will be recorded as a HALF DAY.
