        ...
        <div className="pt-4 border-t border-slate-100 text-center">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <button
              ...
              className="px-2.5 py-1.5 rounded-md bg-slate-100 text-slate-700 hover:bg-sky-100 hover:text-sky-800 font-medium transition-colors"
            >
              👑 CEO (ceo@unitglo.com)
            </button>
            <button
