      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button
            ...
            className="bg-white border-slate-300 font-bold text-xs gap-1.5 shadow-xs"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Successful Runs</div>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Total Emails Sent</div>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Avg Duration</div>
          </div>
        </div>
      </div>

      {/* Manual Dispatch & Testing Control Panel */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 p-6 rounded-2xl text-white shadow-md border border-slate-800">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-4 border-b border-slate-700/60">
          <div>
            ...
            <h2 className="text-xl font-bold text-white mt-0.5">Manual Job Dispatch & Testing</h2>
            <p className="text-slate-300 text-xs mt-1">
              Trigger background email broadcasts or send a test email to your own inbox without waiting for the automated 7:30 AM IST schedule.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-5">
          ...
          <div className="space-y-2.5 bg-white/5 p-4 rounded-xl border border-white/10">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <Button
                ...
                disabled={triggering !== null}
                className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs gap-1.5 shadow-sm"
              >
          ...
          {/* Action 2: Single Test Email */}
          <div className="space-y-2.5 bg-white/5 p-4 rounded-xl border border-white/10">
            <span className="text-xs font-bold text-slate-300 uppercase tracking-wider block">
              2. Single Inbox Test Delivery
            </span>
            <div className="flex gap-2">
              ...
              <Button
                ...
                className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs whitespace-nowrap gap-1.5 shrink-0"
              >
          ...
          <div className="space-y-2.5 bg-white/5 p-4 rounded-xl border border-white/10">
            ...
            <Button
              ...
              disabled={triggering !== null}
              className="w-full bg-white/10 hover:bg-white/20 text-white border-white/20 font-bold text-xs gap-1.5"
            >
              {triggering === "dry_run" ? <RefreshCw className="h-3.5 w-3.5 animate-spin" /> : <FileText className="h-3.5 w-3.5" />}
              Run Calculation Dry-Run (No Emails Sent)
            </Button>
          </div>
        </div>
      </div>
