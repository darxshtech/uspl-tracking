...
export default function DashboardClientShell({ children, user }: DashboardClientShellProps) {
  ...
  const navItems = [
    ...
    { name: "Salary Payout Status", href: "/dashboard/payroll", icon: Banknote, roles: ["Admin", "CEO", "PM"] },
    ...
    { name: "Letters & Certificates", href: "/dashboard/letters", icon: Award, roles: ["Admin", "CEO", "PM", "Developer", "Tester"] },
